...
export interface ProductItem {
  ...
  // Global Media System (Image & Video)
  mediaType?: 'image' | 'video'; // Primary media type to showcase ('image' | 'video')
  imageRatio?: 'Original' | '1:1' | '4:5' | '3:4' | '16:9' | '4:3' | '16:7' | 'Custom' | string;
  customRatioWidth?: number | string;
  customRatioHeight?: number | string;
  imageFit?: 'cover' | 'contain';
  imagePosition?: 'center' | 'top' | 'bottom' | 'left' | 'right' | string;
  imageRatios?: Record<string, string>;
...
export interface ProductCategoryInfo {
  ...
  coverImageRatio?: 'Original' | '1:1' | '4:5' | '3:4' | '16:9' | '4:3' | '16:7' | 'Custom' | string;
  customRatioWidth?: number | string;
  customRatioHeight?: number | string;
  coverImageFit?: 'cover' | 'contain';
  coverImagePosition?: 'center' | 'top' | 'bottom' | 'left' | 'right' | string;
  coverVideoRatio?: 'Original' | '1:1' | '4:5' | '3:4' | '16:9' | '4:3' | '16:7' | 'Custom' | string;
  coverVideoFit?: 'cover' | 'contain';
  coverVideoPosition?: 'center' | 'top' | 'bottom' | 'left' | 'right' | string;
  coverVideoMuted?: boolean;

  // Internal Section Images / Gallery
