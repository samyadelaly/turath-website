...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section className="relative overflow-hidden bg-[#000000] border-b border-[#d4c59d]/30 pt-10 sm:pt-14 lg:pt-16 pb-14 sm:pb-16 lg:pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="flex flex-col items-center text-center space-y-6 sm:space-y-8">
          ...
          <motion.div 
            ...
            className="flex flex-col sm:flex-row items-center gap-3 sm:gap-4 pt-2 sm:pt-3"
          >
            <motion.button
          ...
          <motion.div 
            ...
            className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 pt-8 sm:pt-10 w-full max-w-5xl border-t border-[#d4c59d]/20 text-left"
          >
            <motion.div 
              whileHover={{ y: -3 }}
